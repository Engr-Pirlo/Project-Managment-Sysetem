                ...
                <form>
                    <div className="col-md-12">
                      ...
                      <div className="form-control">
                            ...
                            <input type="text" name='' id='' value="Iphone X max" className='border text-sm focus:outline-none active:outline-none border p-2 border-gray-300 w-w-full md:w-full  p-1 pr-2'/>
                        </div>
                      ...
                      <select name="" id="" className='form-control border border-slate-300 w-full p-2 focus:outline-none focus:border-blue-400 ' >
                        ...
                        <div className="form-control">
                            ...
                            <input type="number" name='' value='23' id='' className='border text-sm focus:outline-none p-2 active:outline-none border border-gray-300 w-full md:w-full  p-1 pr-2 '/>
                        </div>
                        ...
                        <div className="form-control md:col-span-4">
                           ...
                           <textarea name=""  value='lasjsdh sjdfhdbds bfhbdsahbads  bdadbdahb bdhsbewy' className='border w-full focus:outline-none w-full md:w-full  p-1'  id="" cols="30" rows="5" placeholder='Note '></textarea>
                        </div>
